...
void main() {
  group('Server Dashboard Item Navigation Tests:', () {
    ...
    testWidgets('Clicking Personas button navigates to under construction with backUrl',
        (tester) async {
      // Arrange
    ...
    testWidgets('Clicking Characters button navigates to under construction with backUrl',
        (tester) async {
      // Arrange
      final testServer = Server(
        id: 'test-server',
    ...
    testWidgets('Clicking Continue button navigates to under construction with backUrl',
        (tester) async {
      // Arrange
      final testServer = Server(
        id: 'test-server',
    ...
    testWidgets('Back button navigates to server list',
        (tester) async {
      // Arrange
      final testServer = Server(
        id: 'test-server',
    ...
    testWidgets('Logout button clears session and navigates to server list',
      ...
      when(mockConnectionDomain.hasExistingSession(testServer))
          .thenReturn(true);
      when(mockConnectionDomain.logoutFromServer(testServer))
          .thenAnswer((_) async {});
      ...
      await tester.pump(Duration(milliseconds: 100)); // Small delay for async operation
      await tester.pumpAndSettle();
